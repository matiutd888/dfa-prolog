...
% myExample(IdentyfikatorAutomatu, Automat)
myExample(a11, dfa([fp(1,a,1),fp(1,b,2),fp(2,a,2),fp(2,b,1)], 1, [2,1])).
myExample(a12, dfa([fp(x,a,y),fp(x,b,x),fp(y,a,x),fp(y,b,x)], x, [x,y])).
myExample(a2, dfa([fp(1,a,2),fp(2,b,1),fp(1,b,3),fp(2,a,3), fp(3,b,3),fp(3,a,3)], 1, [1])).
myExample(a3, dfa([fp(0,a,1),fp(1,a,0)], 0, [0])).
myExample(a4, dfa([fp(x,a,y),fp(y,a,z),fp(z,a,x)], x, [x])).
myExample(a5, dfa([fp(x,a,y),fp(y,a,z),fp(z,a,zz),fp(zz,a,x)], x, [x])).


myExample(a6, dfa([fp(1,a,1),fp(1,b,2),fp(2,a,2),fp(2,b,1)], 1, [])).
myExample(a7, dfa([fp(1,a,1),fp(1,b,2),fp(2,a,2),fp(2,b,1), fp(3,b,3),fp(3,a,3)], 1, [3])).
% bad ones
myExample(b1, dfa([fp(1,a,1),fp(1,a,1)], 1, [])).
myExample(b2, dfa([fp(1,a,1),fp(1,a,2)], 1, [])).
myExample(b3, dfa([fp(1,a,2)], 1, [])).
myExample(b4, dfa([fp(1,a,1)], 2, [])).
myExample(b4, dfa([fp(1,a,1)], 1, [1,2])).
myExample(b5, dfa([], [], [])).
