...
pawel(loop_in_another_branch_1a, dfa([fp(1, b, 2), fp(1, a, 3), fp(2, a, 2), fp(2, b, 2), fp(3, a, 4), fp(3, b, 4), fp(4, a, 4), fp(4, b, 4)], 1, [2, 3])).
pawel(loop_in_another_branch_1b, dfa([fp(1, a, 2), fp(1, b, 3), fp(2, a, 2), fp(2, b, 2), fp(3, a, 4), fp(3, b, 4), fp(4, a, 4), fp(4, b, 4)], 1, [2, 3])).
pawel(loop_in_another_branch_2a, dfa([fp(1, a, 2), fp(1, b, 5), fp(2, a, 3), fp(2, b, 4), fp(3, a, 4), fp(3, b, 4), fp(4, a, 4), fp(4, b, 4), fp(5, a, 4), fp(5, b, 5)], 1, [3, 5])).
pawel(loop_in_another_branch_2b, dfa([fp(1, b, 2), fp(1, a, 5), fp(2, a, 3), fp(2, b, 4), fp(3, a, 4), fp(3, b, 4), fp(4, a, 4), fp(4, b, 4), fp(5, b, 4), fp(5, a, 5)], 1, [3, 5])).
